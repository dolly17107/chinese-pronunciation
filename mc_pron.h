...
static std::vector<mc_initial_datus> const mc_initial_data = {
    ...
    { std::string("滂"), std::string("ph"), std::string("pʰ"), αβ::αβ,
        { std::string("pʰ"/*"ph"*/), std::string("ɸʰ"/*"ɸh"*/) }, std::string("pʰ"/*"ph"*/), { std::string("pʰ"/*"ph"*/), std::string("f") } },
    { std::string("並"), std::string("b"), std::string("bʰ"), αβ::αβ,
        { std::string("b"), std::string("β") }, std::string("b"), { std::string("p̤"/*"b̤"*/), std::string("f̤"/*"v̤"*/) } },
    { std::string("明"), std::string("m"), std::string("m"), αβ::αβ,
        std::string("m"), std::string("m"), { std::string("ᵐb"/*"mb"*/), std::string("w̃") } },
    { std::string("端"), std::string("t"), std::string("t"), std::nullopt, std::string("t"), std::string("t"), std::string("t") },
    { std::string("透"), std::string("th"), std::string("tʰ"), std::nullopt, std::string("tʰ"/*"th"*/), std::string("tʰ"/*"th"*/), std::string("tʰ"/*"th"*/) },
    { std::string("定"), std::string("d"), std::string("dʰ"), std::nullopt, std::string("d"), std::string("d"), std::string("t̤"/*"d̤"*/) },
    { std::string("泥"), std::string("n"), std::string("n"), std::nullopt, std::string("n"), std::string("n"), std::string("ⁿd"/*"nd"*/) },
    ...
    { std::string("徹"), std::string("trh"), std::string("ţʰ"), αβ::β, std::string("tʰ"/*"th"*/), std::string("ʈʰ"/*"ʈh"*/), std::string("ʈʰ"/*"ʈh"*/) },
    { std::string("澄"), std::string("dr"), std::string("ɖʰ"), αβ::β, std::string("d"), std::string("ɖ"), std::string("ʈ̤"/*"ɖ̤"*/) },
    { std::string("娘"), std::string("nr"), std::string("ɳ"), αβ::β, std::string("n"), std::string("ɳ"), std::string("ᶯɖ"/*"ɳɖ"*/) },
    { std::string("精"), std::string("ts"), std::string("ts"), αβ::α, std::string("ts"/*"tz"*/), std::string("ts"/*"tz"*/), std::string("ts"/*"tz"*/) },
    { std::string("清"), std::string("tsh"), std::string("tsʰ"), αβ::α, std::string("tsʰ"/*"ts"*/), std::string("tsʰ"/*"ts"*/), std::string("tsʰ"/*"ts"*/) },
    { std::string("從"), std::string("dz"), std::string("dzʰ"), αβ::α, std::string("dz"), std::string("dz"), std::string("t̤s̤"/*"d̤z"*/) },
    { std::string("心"), std::string("s"), std::string("s"), αβ::α, std::string("s"), std::string("s"), std::string("s") },
    { std::string("邪"), std::string("z"), std::string("z"), αβ::α, std::string("dz"), std::string("z"), std::string("s̤"/*"z̤"*/) },
    { std::string("莊"), std::string("tsr"), std::string("ʧ"), αβ::β, std::string("ʈʂ"/*"ʈʐ"*/), std::string("ʈʂ"/*"ʈʐ"*/), std::string("ʈʂ"/*"ʈʐ"*/) },
    { std::string("初"), std::string("tsrh"), std::string("ʧʰ"), αβ::β, std::string("ʈʂʰ"/*"ʈʂ"*/), std::string("ʈʂʰ"/*"ʈʂ"*/), std::string("ʈʂʰ"/*"ʈʂ"*/) },
    { std::string("崇"), std::string("dzr"), std::string("dʒʰ"), αβ::β, std::string("ɖʐ"), std::string("ɖʐ"), std::string("ʈ̤ʂ̤"/*"ɖ̤ʐ"*/) },
    { std::string("生"), std::string("sr"), std::string("ʃ"), αβ::β, std::string("ʂ"), std::string("ʂ"), std::string("ʂ") },
    { std::string("俟"), std::string("zr"), std::string("dʐʰ"), αβ::β, std::string("ɖʐ"), std::string("ʐ"), std::string("ʂ̤"/*"ʐ"*/) }, // merged with 崇 in 廣韻
    { std::string("章"), std::string("tsy"), std::string("tɕ"), αβ::α, std::string("tɕ"/*"cʑ"*/), std::string("tɕ"/*"cʑ"*/), std::string("tɕ"/*"cʑ"*/) },
    { std::string("昌"), std::string("tsyh"), std::string("tɕʰ"), αβ::α, std::string("tɕʰ"/*"cɕ"*/), std::string("tɕʰ"/*"cɕ"*/), std::string("tɕʰ"/*"cɕ"*/) },
    { std::string("禪"), std::string("dzy"), std::string("ʑ"), αβ::α, std::string("dʑ"/*"ɟʑ"*/), std::string("dʑ"/*"ɟʑ"*/), std::string("t̤ɕ̤"/*"ɟ̤ʑ"*/) },
    { std::string("日"), std::string("ny"), std::string("nʑ"), αβ::α, std::string("ɲ"), std::string("ɲ"), std::string("ᶮdʑ"/*"ɲɟʑ"*/) },
    { std::string("書"), std::string("sy"), std::string("ɕ"), αβ::α, std::string("ɕ"), std::string("ɕ"), std::string("ɕ") },
    { std::string("船"), std::string("zy"), std::string("dʑʰ"), αβ::α, std::string("dʑ"/*"ɟʑ"*/), std::string("ʑ"), std::string("ɕ̤"/*"ʑ̤"*/) },
    ...
    { std::string("溪"), std::string("kh"), std::string("kʰ"), αβ::αβ, std::string("kʰ"/*"kh"*/), std::string("kʰ"/*"kh"*/), std::string("kʰ"/*"kh"*/) },
    { std::string("群"), std::string("g"), std::string("gʰ"), αβ::αβ, std::string("g"), std::string("g"), std::string("k̤"/*"g̤"*/) },
    { std::string("疑"), std::string("ng"), std::string("ŋ"), αβ::αβ, std::string("ŋ"), std::string("ŋ"), std::string("ᵑg"/*"ŋg"*/) },
    ...
    { std::string("匣"), std::string("h"), std::string("ɣ"), std::nullopt, std::string("ɦ"), std::string("ɣ"), std::string("x̤"/*"ɣ̤"*/) },
...
static std::vector<mc_final_class> const mc_final_data{
    ...
    {"", { mc_韻部::東B, 3, 0, 0 }, "juwng", "ĭuŋ", {"ɯwŋ", "ɤwŋ", "ɤwŋ"/*"ɤwŋ/uŋ competing"*/}}, /* TODO: Find correct pronunciation for every character */
    {"", { mc_韻部::東B, 3, 0, 1 }, "juwk", "ĭuk", {"ɯwk", "ɤwk", "ɤwk"/*"ɤwk/uk competing"*/}}, /* TODO: Find correct pronunciation for every character */
    ...
    {"", { mc_韻部::佳, 2, 0, 0 }, "ea", "ai", {"æ"/*"æ/æj dialectal mixture"*/, "æ"/*"æ/æj dialectal mixture"*/}}, /* TODO: Find correct pronunciation for every character */
    {"", { mc_韻部::佳, 2, 1, 0 }, "wea", "wai", {"wæ"/*"wæ/wæj dialectal mixture"*/, "wæ"/*"wæ/wæj dialectal mixture"*/}}, /* TODO: Find correct pronunciation for every character */
    ...
    {"", { mc_韻部::尤, 3, 0, 0 }, "juw", "ĭəu", {"ɯw", "ɤw", "u"/*"ɤw/u competing"*/}, {{"iw", "iw", "iw"}}}, /* TODO: Find correct pronunciation for every character */
