...
static std::vector<mc_final_class> const mc_final_data{
    ...
    {"", { mc_韻部::文, 3, 1, 0 }, "jun", "ĭuən", {"wɯn", "wɯn"}},
    {"", { mc_韻部::文, 3, 1, 1 }, "jut", "ĭuət", {"wɯt", "wɯt"}},
    ...
    {"宵超朝𪓙樵焦饒燒遙韶昭鴞鍫怊燎小肇沼巐少擾𪍑紹鷕悄𠞰繚𥬇照燿召邵噍陗𤊽醮少朓饒", { mc_韻部::宵, 3, 0, 0 }, "jew", "ĭɛu", {"ew", "ew"}},
    ...
    {"侵尋林琛斟沈碪諶任深淫心祲𩷒䛘森岑兂嵾𧡪寑朕廩罧踸䤐荏枕沈葚甚瀋墋拰蕈㾕戡潭𩒣沁浸妊鴆枕賃滲闖譖讖揕臨甚䫴深", { mc_韻部::侵, 3, 1, 0 }, "im", "ĭĕm", {"ɯm", "ɯm"}},
    {"緝十執習集入溼㗱蟄縶立𩎕歰戢湁煜熠孨霵㞚卙", { mc_韻部::侵, 3, 1, 1 }, "ip", "ĭĕp", {"ɯp", "ɯp"}},
    ...
    {"鹽廉銛籤詹棎苫䪜𩓾黏炎霑覘尖潛燅襳㶣琰斂颭冉陝諂漸憸𩟗剡豔贍染閃𡄑壍殮覘䠨潛占", { mc_韻部::鹽, 3, 0, 0 }, "jem", "ĭɛm", {"em", "em"}},
    {"葉接攝涉獵捷䐑聶謵讘讋妾鍤輒曄萐", { mc_韻部::鹽, 3, 0, 1 }, "jep", "ĭɛp", {"ep", "ep"}},
